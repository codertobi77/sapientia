...
export function PageHero({
  ...
  return (
    <section className={cn("bg-navy text-white relative overflow-hidden", className)}>
      ...
      <div className="container-site relative py-16 lg:py-20 z-10">
        <span className="inline-block text-xs font-bold uppercase tracking-[0.2em] text-gold mb-4">
          {eyebrow}
        </span>
        <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-[1.05] text-pretty max-w-4xl">
          {title}
        </h1>
        {description && (
          <p className="mt-6 text-lg text-white/80 leading-relaxed max-w-2xl text-pretty">
            {description}
          </p>
        )}
